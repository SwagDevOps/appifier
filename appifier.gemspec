...
Gem::Specification.new do |s|
  ...
  s.files         = [
    ...
    "lib/appifier/mixins/fs.rb",
    "lib/appifier/mixins/inject.rb",
    "lib/appifier/mixins/printer.rb",
    ...
    "lib/appifier/scripts/dockerfile.rb",
    "lib/appifier/scripts/functions_sh.rb",
    "lib/appifier/scripts/pkg2appimage.rb",
    "lib/appifier/scripts/pkg2appimage_with_docker.rb",
